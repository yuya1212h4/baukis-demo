...
describe Admin::StaffMembersController do
  ...
  describe "#create" do
    ...
    example '例外ActionController::ParameterMissingが発生' do
      bypass_rescue # rescure_fromによる例外処理を無効にする
  ...
  describe "#update" do
    ...
    example 'hashed_passwordの値は書き換え不可' do
      ...
      expect{ patch :update, params: { id: staff_member.id, staff_member: params_hash} }.not_to change { staff_member[:hashed_params].to_s }
    end
  end
end
